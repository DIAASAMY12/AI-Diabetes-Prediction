...
# saveModel("model/model.h5", classifier)
import pickle

def saveModelpkl(fileName, model):
...
# Save the DecisionTreeClassifier model as a pickle file
saveModelpkl("model/model.pkl", classifier)
